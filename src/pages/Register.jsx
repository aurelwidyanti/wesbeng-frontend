...
const Register = () => {
  return (
    <div className='login sm:flex-row min-h-screen  flex flex-col'>
        ...
        <div className="mainLogin flex justify-center  flex-1">
            <div className="flex-col flex-1 m-auto mt-[-90px] sm:my-auto">
                <div class="sm:w-3/5 p-4 h-max bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 m-auto w-11/12 content-center">
                    <form class="" action="#">
                        <h5 className="text-2xl font-bold text-gray-900">Daftar Sekarang!</h5>
                        ...
                        <div className='mt-3'>
                            <label for="cnfrmPassword" class="block mb-2 text-sm font-medium text-gray-900 ">Confirm Password</label>
                            <input type="password" name="cnfrmPassword" id="cnfrmPassword" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
